    ...
    QDialog(parent)
{
    ...
    ui.status_label->setText("Prepare to connect to the database");
}
...
void ConnDlg::on_okButton_clicked()
{
    ...
    {
        ui.status_label->setText("Please choose a database driver!");
    ...
    else
    {
        ...
        if(err.type()!=QSqlError::NoError)
            ...
            ui.status_label->setText("Connect the database successfully!");
        accept();
    }
}
...
void ConnDlg::addSqliteConnection()
{
    ...
    ui.status_label->setText("create sqlite database successfully!");
}
