           ...
           QWidget *parent): QMainWindow(parent)
{
    ...
    createMenuBar();
    resize(850,400);
    setWindowTitle("Master-detail views");
}
...
QGroupBox* MainWindow::createFactoryGroupBox()
{
    ...
    QGroupBox *box=new QGroupBox("automaker");
    QGridLayout *layout=new QGridLayout;
...
{
    QGroupBox *box=new QGroupBox("car");
...
{
    QGroupBox *box=new QGroupBox("detail");
...
void MainWindow::createMenuBar()
{
    ...
    QMenu *fileMenu=menuBar()->addMenu(tr("Operation"));
...
void MainWindow::delCar()
{
    ...
    if(!selection.empty())
    {
        ...
        button=QMessageBox::question(this,tr("delete car record"),QString(tr("Are you sure to delete %2 from %1?").arg(
                                         factory).arg(name)),QMessageBox::Yes|QMessageBox::No);
        ...
        {
            QMessageBox::information(this,"delete car record","Please choose the record you want to delete");
        }
    }
}
