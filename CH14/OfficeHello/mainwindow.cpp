...
void MainWindow::on_writeExcelPushButton_clicked()
{
    ...
    sheet->setProperty("Name","Love Qt");
    ...
    workbook->dynamicCall("SaveAs(const QString&)","E:\\programme\\Qt\\office\\LoveQt5.xls");
    workbook->dynamicCall("Close()");
    myexcel->dynamicCall("Quit()");
    QMessageBox::information(this,"Over","Excel workbook is saved.");
...
void MainWindow::on_readExcelPushButton_clicked()
{
    myexcel=new QAxObject("Excel.Application");
    myworks=myexcel->querySubObject("WorkBooks");
    myworks->dynamicCall("Open(const QString&)","E:\\programme\\Qt\\office\\LoveQt5.xls");
    workbook=myexcel->querySubObject("ActiveWorkBook");
    ...
    workbook->dynamicCall("Close()");
    myexcel->dynamicCall("Quit()");
    QMessageBox::information(this,"message",outStr);
...
void MainWindow::on_writeWordPushButton_clicked()
{
    ...
    document->dynamicCall("SaveAs(const QString&)","E:\\programme\\Qt\\office\\LoveQt5.doc");
    delete paragraph;
    paragraph=nullptr;
    document->dynamicCall("Close()");
    myword->dynamicCall("Quit()");
    QMessageBox::information(this,"Over","Word doc is saved.");
    ui->writeWordPushButton->setEnabled(false);
...
void MainWindow::on_readWordPushButton_clicked()
{
    myword=new QAxObject("Word.Application");
    mydocs=myword->querySubObject("Documents");
    mydocs->dynamicCall("Open(const QString&)","E:\\programme\\Qt\\office\\LoveQt5.doc");
    ...
    document->dynamicCall("Close()");
    myword->dynamicCall("Quit()");
    QMessageBox::information(this,"information",outStr);
