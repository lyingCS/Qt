...
void MainWindow::createActions()
{
    ...
    addEllipseItemAct=new QAction("Add Ellipse",this);
    addPolygonItemAct=new QAction("Add Polygon",this);
    addTextItemAct=new QAction("Add Text",this);
    addRectItemAct=new QAction("Add Rectangl",this);
    addAlphaItemAct=new QAction("Add Alpha",this);
    addFlashItemAct=new QAction("Add flash Ellipse",this);
    addAnimItemAct=new QAction("Add star",this);
...
void MainWindow::createMenus()
{
    ...
    QMenu*itemsMenu=menuBar()->addMenu("Elements");
